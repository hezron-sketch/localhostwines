...
export default function Home() {
  return (
    <>
      ...
      <div>
        {/* Hero Section */}
        <section className="hero bg-cover bg-center h-screen flex items-center justify-center text-white text-center">
          <div className="hero-content max-w-lg">
            ...
            <div className="inter.className">
              ...
              <p className="mt-4 text-small font-light">
                True Friendship while discovering the finest from all over the
                world.
              </p>
            </div>
            <a
